...
def print_info():
    ...
    log_with_time("Converts all cbz and cbr files to pdf files.")
    divider_with_time()
    ...
    log_with_time("Delete: 'archives', 'pdf', 'compressed'  subfolder")
    log_with_time("From:   'compressed' subfolder")
    log_with_time("To:     'directory path'")
    log_with_time("Moves files from the 'compressed' folder to its parent directory and deletes subfolders.")
    divider_with_time()
...
def print_menu():
    ...
    divider_with_time()
    log_with_time("   9. Combine pdf files")
    # log_with_time("   10. Combine images")
    # log_with_time("   11. Combine subfolders images")
    divider_with_time()
